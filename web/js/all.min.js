if (! function(t, e) {
        ...
        function x(t) {
            var e = J,
                n = Wt[t];
            return n || (n = b(t, e), "none" !== n && n || (Ft = (Ft || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = Ft[0].contentDocument, e.write(), e.close(), n = b(t, e), Ft.detach()), Wt[t] = n), n
        }

        function w(t, e, n) {
            var i, o, r, s, a = t.style;
            return n = n || Ut(t), n && (s = n.getPropertyValue(e) || n[e]), n && ("" !== s || Z.contains(t.ownerDocument, t) || (s = Z.style(t, e)), Bt.test(s) && Mt.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
        }
        ...
        function k(t, e, n) {
            ...
            if (0 >= o || null == o) {
                if (o = w(t, e, r), (0 > o || null == o) && (o = t.style[e]), Bt.test(o)) return o;
        ...
        function N(t, e) {
            for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++) i = t[s], i.style && (r[s] = vt.get(i, "olddisplay"), n = i.style.display, e ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Ct(i) && (r[s] = vt.access(i, "olddisplay", x(i.nodeName)))) : (o = Ct(i), "none" === n && o || vt.set(i, "olddisplay", o ? n : Z.css(i, "display"))));
        ...
        function O(t, e, n) {
            ...
            })), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [f.overflow, f.overflowX, f.overflowY], c = Z.css(t, "display"), u = "none" === c ? vt.get(t, "olddisplay") || x(t.nodeName) : c, "inline" === u && "none" === Z.css(t, "float") && (f.display = "inline-block")), n.overflow && (f.overflow = "hidden", p.always(function() {
            ...
            if (Z.isEmptyObject(d)) "inline" === ("none" === c ? x(t.nodeName) : c) && (f.display = c);
            else {
                g ? "hidden" in g && (h = g.hidden) : g = vt.access(t, "fxshow", {}), r && (g.hidden = !h), h ? Z(t).show() : p.done(function() {
                    Z(t).hide()
                }), p.done(function() {
                    var e;
                    vt.remove(t, "fxshow");
        ...
        function L(t, e, n) {
            var i, o, r = 0,
                ...
                l = function() {
                    if (o) return !1;
                    for (var e = Gt || D(), n = Math.max(0, c.startTime + c.duration - e), i = n / c.duration || 0, r = 1 - i, s = 0, l = c.tweens.length; l > s; s++) c.tweens[s].run(r);
        ...
        var ot = function(t) {
            function e(t, e, n, i) {
                ...
                if ((e ? e.ownerDocument || e : W) !== O && j(e), e = e || O, n = n || [], !t || "string" != typeof t) return n;
                ...
                if (L && !i) {
                    if (o = yt.exec(t))
                        ...
                        if (f = p = F, h = e, g = 9 === a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                            for (c = $(t), (p = e.getAttribute("id")) ? f = p.replace(xt, "\\$&") : e.setAttribute("id", f), f = "[id='" + f + "'] ", l = c.length; l--;) c[l] = f + d(c[l]);
            ...
            function f(t, e, n) {
                ...
                return e.first ? function(e, n, r) {
                    ...
                    if (s) {
                        ...
                        for (; e = e[i];)
                            if (1 === e.nodeType || o) {
                                if (l = e[F] || (e[F] = {}), (a = l[i]) && a[0] === M && a[1] === r) return c[2] = a[2];
                ...
                return o && !o[F] && (o = v(o)), r && !r[F] && (r = v(r, s)), i(function(i, s, a, l) {
                    ...
                    if (i) {
                        if (r || t) {
                            ...
                            for (u = b.length; u--;)(p = b[u]) && (c = r ? et.call(i, p) : d[u]) > -1 && (i[c] = !(s[c] = p))
                        }
            ...
            var x, w, T, C, E, $, k, N, S, D, A, j, O, I, L, R, H, P, q, F = "sizzle" + -new Date,
                W = t.document,
                M = 0,
                B = 0,
                U = n(),
            ...
            try {
                Z.apply(G = tt.call(W.childNodes), W.childNodes), G[W.childNodes.length].nodeType
            } catch (t) {
                Z = {
            ...
            w = e.support = {}, E = e.isXML = function(t) {
                ...
                var e, n = t ? t.ownerDocument || t : W,
                    i = n.defaultView;
                return n !== O && 9 === n.nodeType && n.documentElement ? (O = n, I = n.documentElement, L = !E(n), i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", function() {
                    j()
                ...
                }, H = [], R = [], (w.qsa = vt.test(n.querySelectorAll)) && (o(function(t) {
                    t.innerHTML = "<select msallowclip=''><option selected=''></option></select>", t.querySelectorAll("[msallowclip^='']").length && R.push("[*^$]=" + it + "*(?:''|\"\")"), t.querySelectorAll("[selected]").length || R.push("\\[" + it + "*(?:value|" + nt + ")"), t.querySelectorAll(":checked").length || R.push(":checked")
                }), o(function(t) {
                ...
                })), (w.matchesSelector = vt.test(P = I.matches || I.webkitMatchesSelector || I.mozMatchesSelector || I.oMatchesSelector || I.msMatchesSelector)) && o(function(t) {
                    w.disconnectedMatch = P.call(t, "div"), P.call(t, "[s!='']:x"), H.push("!=", at)
                }), R = R.length && new RegExp(R.join("|")), H = H.length && new RegExp(H.join("|")), e = vt.test(I.compareDocumentPosition), q = e || vt.test(I.contains) ? function(t, e) {
                    ...
                    return i ? i : (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & i || !w.sortDetached && e.compareDocumentPosition(t) === i ? t === n || t.ownerDocument === W && q(W, t) ? -1 : e === n || e.ownerDocument === W && q(W, e) ? 1 : D ? et.call(D, t) - et.call(D, e) : 0 : 4 & i ? -1 : 1)
                } : function(t, e) {
                    if (t === e) return A = !0, 0;
                    var i, o = 0,
                        r = t.parentNode,
                        ...
                        l = [t],
                        c = [e];
                    if (!r || !a) return t === n ? -1 : e === n ? 1 : r ? -1 : a ? 1 : D ? et.call(D, t) - et.call(D, e) : 0;
                    if (r === a) return s(t, e);
                ...
                if ((t.ownerDocument || t) !== O && j(t), n = n.replace(pt, "='$1']"), !(!w.matchesSelector || !L || H && H.test(n) || R && R.test(n))) try {
                    var i = P.call(t, n);
                ...
                filter: {
                        ...
                        return 1 === i && 0 === o ? function(t) {
                            ...
                            if (m) {
                                ...
                                if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                    for (u = m[F] || (m[F] = {}), c = u[t] || [], f = c[0] === M && c[1], d = c[0] === M && c[2], p = f && m.childNodes[f]; p = ++f && p && p[g] || (d = f = 0) || h.pop();)
                                        if (1 === p.nodeType && ++d && p === e) {
                                            u[t] = [M, f, d];
                                            break
                                        }
                                } else if (y && (c = (e[F] || (e[F] = {}))[t]) && c[0] === M) d = c[1];
                                else
                                    for (;
                                        (p = ++f && p && p[g] || (d = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++d || (y && ((p[F] || (p[F] = {}))[t] = [M, d]), p !== e)););
                    ...
                    PSEUDO: function(t, n) {
                        ...
                        return r[F] ? r(n) : r.length > 1 ? (o = [t, t, "", n], T.setFilters.hasOwnProperty(t.toLowerCase()) ? i(function(t, e) {
                            for (var i, o = r(t, n), s = o.length; s--;) i = et.call(t, o[s]), t[i] = !(e[i] = o[s])
                        }) : function(t) {
                            return r(t, 0, o)
                        }) : r
                    }
            ...
            return p.prototype = T.filters = T.pseudos, T.setFilters = new p, $ = e.tokenize = function(t, n) {
                ...
                for (a = t, l = [], c = T.preFilter; a;) {
                    ...
                    for (s in T.filter) !(o = ht[s].exec(a)) || c[s] && !(o = c[s](o)) || (i = o.shift(), r.push({
                        value: i,
                        type: s,
                        matches: o
                    }), a = a.slice(i.length));
                ...
                if (n = n || [], 1 === p.length) {
                    ...
                    for (o = ht.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !T.relative[a = s.type]);)
                        if ((l = T.find[a]) && (i = l(s.matches[0].replace(wt, Tt), bt.test(r[0].type) && u(e.parentNode) || e))) {
                            if (r.splice(o, 1), t = i.length && d(r), !t) return Z.apply(n, i), n;
                            break
                        }
                }
                return (c || k(t, p))(i, e, !L, n, bt.test(t) && u(e.parentNode) || e), n
        ...
        Z.extend({
            ...
            Z.fn[t] = function(n, i) {
                ...
                return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (o = Z.filter(i, o)), this.length > 1 && (dt[t] || Z.unique(o), pt.test(t) && o.reverse()), this.pushStack(o)
            }
        });
        var ft = /\S+/g,
            ht = {};
        Z.Callbacks = function(t) {
            t = "string" == typeof t ? ht[t] || r(t) : Z.extend({}, t);
            var e, n, i, o, s, a, l = [],
                c = !t.once && [],
                u = function(r) {
        ...
        Z.acceptData = function(t) {
            ...
            remove: function(t, e) {
                ...
                if (void 0 === e) this.cache[r] = {};
                    ...
                    Z.isArray(e) ? i = e.concat(e.map(Z.camelCase)) : (o = Z.camelCase(e), e in s ? i = [e, o] : (i = o, i = i in s ? [i] : i.match(ft) || [])), n = i.length;
                    for (; n--;) delete s[i[n]]
                }
            },
            hasData: function(t) {
        ...
        Z.event = {
            ...
            add: function(t, e, n, i, o) {
                var r, s, a, l, c, u, p, d, f, h, g, m = vt.get(t);
                if (m)
                    for (n.handler && (r = n, n = r.handler, o = r.selector), n.guid || (n.guid = Z.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(e) {
                        ...
                        }), e = (e || "").match(ft) || [""], c = e.length; c--;) a = Dt.exec(e[c]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f && (p = Z.event.special[f] || {}, f = (o ? p.delegateType : p.bindType) || f, p = Z.event.special[f] || {}, u = Z.extend({
                        type: f,
                        origType: g,
                        data: i,
                        handler: n,
            ...
            remove: function(t, e, n, i, o) {
                var r, s, a, l, c, u, p, d, f, h, g, m = vt.hasData(t) && vt.get(t);
                if (m && (l = m.events)) {
                    for (e = (e || "").match(ft) || [""], c = e.length; c--;)
                        if (a = Dt.exec(e[c]) || [], f = g = a[1], h = (a[2] || "").split(".").sort(), f) {
            ...
            trigger: function(e, n, i, o) {
                var r, s, a, l, c, u, p, d = [i || J],
                    f = Y.call(e, "type") ? e.type : e,
                    h = Y.call(e, "namespace") ? e.namespace.split(".") : [];
                if (s = a = i = i || J, 3 !== i.nodeType && 8 !== i.nodeType && !St.test(f + Z.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."), f = h.shift(), h.sort()), c = f.indexOf(":") < 0 && "on" + f, e = e[Z.expando] ? e : new Z.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = h.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : Z.makeArray(n, [e]), p = Z.event.special[f] || {}, o || !p.trigger || p.trigger.apply(i, n) !== !1)) {
                    if (!o && !p.noBubble && !Z.isWindow(i)) {
                        for (l = p.delegateType || f, St.test(l + f) || (s = s.parentNode); s; s = s.parentNode) d.push(s), a = s;
                        a === (i.ownerDocument || J) && d.push(a.defaultView || a.parentWindow || t)
                    }
                    for (r = 0;
                        (s = d[r++]) && !e.isPropagationStopped();) e.type = r > 1 ? l : p.bindType || f, u = (vt.get(s, "events") || {})[e.type] && vt.get(s, "handle"), u && u.apply(s, n), u = c && s[c], u && u.apply && Z.acceptData(s) && (e.result = u.apply(s, n), e.result === !1 && e.preventDefault());
            ...
            fix: function(t) {
                ...
                var e, n, i, o = t.type,
                    r = t,
                    s = this.fixHooks[o];
                for (s || (this.fixHooks[o] = s = Nt.test(o) ? this.mouseHooks : kt.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, t = new Z.Event(r), e = i.length; e--;) n = i[e], t[n] = r[n];
        ...
        qt.optgroup = qt.option, qt.tbody = qt.tfoot = qt.colgroup = qt.caption = qt.thead, qt.th = qt.td, Z.extend({
            ...
            buildFragment: function(t, e, n, i) {
                for (var o, r, s, a, l, c, u = e.createDocumentFragment(), p = [], d = 0, f = t.length; f > d; d++)
                    if (o = t[d], o || 0 === o)
                        if ("object" === Z.type(o)) Z.merge(p, o.nodeType ? [o] : o);
                        else if (Ot.test(o)) {
                    for (r = r || u.appendChild(e.createElement("div")), s = (jt.exec(o) || ["", ""])[1].toLowerCase(), a = qt[s] || qt._default, r.innerHTML = a[1] + o.replace(At, "<$1></$2>") + a[2], c = a[0]; c--;) r = r.lastChild;
            ...
            html: function(t) {
                return mt(this, function(t) {
                    ...
                    if ("string" == typeof t && !It.test(t) && !qt[(jt.exec(t) || ["", ""])[1].toLowerCase()]) {
                        t = t.replace(At, "<$1></$2>");
                        try {
            ...
            domManip: function(t, e) {
                ...
                var n, i, o, r, s, a, l = 0,
                    ...
                    d = t[0],
                    g = Z.isFunction(d);
                if (g || c > 1 && "string" == typeof d && !G.checkClone && Lt.test(d)) return this.each(function(n) {
                    var i = u.eq(n);
                ...
                if (c && (n = Z.buildFragment(t, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
                    ...
                    if (r)
                        for (a = o[o.length - 1].ownerDocument, Z.map(o, h), l = 0; r > l; l++) s = o[l], Rt.test(s.type || "") && !vt.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(Pt, "")))
                }
                return this
            }
        }), Z.each({
        ...
        Z.extend({
            ...
            style: function(t, e, n, i) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    var o, r, s, a = Z.camelCase(e),
                        l = t.style;
                    return e = Z.cssProps[a] || (Z.cssProps[a] = C(l, a)), s = Z.cssHooks[e] || Z.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (o = s.get(t, !1, i)) ? o : l[e] : (r = typeof n, "string" === r && (o = Xt.exec(n)) && (n = (o[1] + 1) * o[2] + parseFloat(Z.css(t, e)), r = "number"), void(null != n && n === n && ("number" !== r || Z.cssNumber[a] || (n += "px"), G.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), s && "set" in s && void 0 === (n = s.set(t, n, i)) || (l[e] = n))))
                }
            },
            css: function(t, e, n, i) {
                var o, r, s, a = Z.camelCase(e);
                return e = Z.cssProps[a] || (Z.cssProps[a] = C(t.style, a)), s = Z.cssHooks[e] || Z.cssHooks[a], s && "get" in s && (o = s.get(t, !0, n)), void 0 === o && (o = w(t, e, i)), "normal" === o && e in Qt && (o = Qt[e]), "" === n || n ? (r = parseFloat(o), n === !0 || Z.isNumeric(r) ? r || 0 : o) : o
            }
        }), Z.each(["height", "width"], function(t, e) {
            Z.cssHooks[e] = {
                get: function(t, n, i) {
                    return n ? _t.test(Z.css(t, "display")) && 0 === t.offsetWidth ? Z.swap(t, Vt, function() {
                        return k(t, e, i)
                    }) : k(t, e, i) : void 0
                },
                set: function(t, n, i) {
            ...
            }, Mt.test(t) || (Z.cssHooks[t + e].set = E)
        }), Z.fn.extend({
            css: function(t, e) {
                return mt(this, function(t, e, n) {
                    var i, o, r = {},
                        s = 0;
                    if (Z.isArray(e)) {
                        for (i = Ut(t), o = e.length; o > s; s++) r[e[s]] = Z.css(t, e[s], !1, i);
                        return r
                    }
        ...
        Z.fn.extend({
            ...
            toggleClass: function(t, e) {
                ...
                return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : this.each(Z.isFunction(t) ? function(n) {
                    ...
                    if ("string" === n)
                        for (var e, i = 0, o = Z(this), r = t.match(ft) || []; e = r[i++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
        ...
        pe = be.exec(de.toLowerCase()) || [], Z.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ajaxSettings: {
            ...
            ajax: function(t, e) {
                ...
                if (h.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, p.url = ((t || p.url || de) + "").replace(fe, "").replace(ye, pe[1] + "//"), p.type = e.method || e.type || p.method || p.type, p.dataTypes = Z.trim(p.dataType || "*").toLowerCase().match(ft) || [""], null == p.crossDomain && (l = be.exec(p.url.toLowerCase()), p.crossDomain = !(!l || l[1] === pe[1] && l[2] === pe[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (pe[3] || ("http:" === pe[1] ? "80" : "443")))), p.data && p.processData && "string" != typeof p.data && (p.data = Z.param(p.data, p.traditional)), H(xe, p, e, w), 2 === b) return w;
                c = p.global, c && 0 === Z.active++ && Z.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !ve.test(p.type), o = p.url, p.hasContent || (p.data && (o = p.url += (ue.test(o) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = he.test(o) ? o.replace(he, "$1_=" + ce++) : o + (ue.test(o) ? "&" : "?") + "_=" + ce++)), p.ifModified && (Z.lastModified[o] && w.setRequestHeader("If-Modified-Since", Z.lastModified[o]), Z.etag[o] && w.setRequestHeader("If-None-Match", Z.etag[o])), (p.data && p.hasContent && p.contentType !== !1 || e.contentType) && w.setRequestHeader("Content-Type", p.contentType), w.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Te + "; q=0.01" : "") : p.accepts["*"]);
        ...
        Z.param = function(t, e) {
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    var t = this.type;
                    return this.name && !Z(this).is(":disabled") && Ne.test(this.nodeName) && !ke.test(t) && (this.checked || !Et.test(t))
                }).map(function(t, e) {
                    var n = Z(this).val();
        ...
        t.ActiveXObject && Z(t).on("unload", function() {
        ...
        }), G.cors = !!je && "withCredentials" in je, G.ajax = je = !!je, Z.ajaxTransport(function(t) {
            var e;
            return G.cors || je && !t.crossDomain ? {
                send: function(n, i) {
                    ...
                    e = function(t) {
                        return function() {
                            e && (delete De[s], e = r.onload = r.onerror = null, "abort" === t ? r.abort() : "error" === t ? i(r.status, r.statusText) : i(Ae[r.status] || r.status, r.statusText, "string" == typeof r.responseText ? {
                                text: r.responseText
                            } : void 0, r.getAllResponseHeaders()))
                        }
                    }, r.onload = e(), r.onerror = e("error"), e = De[s] = e("abort");
                    // try {
        ...
        Z.ajaxSetup({
            ...
            return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = Z.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Ie, "$1" + o) : e.jsonp !== !1 && (e.url += (ue.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function() {
        ...
        Z.offset = {
            ...
            offset: function(t) {
                ...
                var e, n, i = this[0],
                    ...
                    r = i && i.ownerDocument;
                return r ? (e = r.documentElement, Z.contains(e, i) ? (typeof i.getBoundingClientRect !== $t && (o = i.getBoundingClientRect()), n = M(r), {
        ...
        return Z.noConflict = function(e) {
            return t.$ === Z && (t.$ = Pe), e && t.jQuery === Z && (t.jQuery = He), Z
