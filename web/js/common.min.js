function getURLVar(t) {
    ...
    var o = String(document.location.pathname).split("/");
    return "cart" == o[o.length - 1] && (e.route = "checkout/cart"), "checkout" == o[o.length - 1] && (e.route = "checkout/checkout"), e[t] ? e[t] : ""
}
$(document).ready(function() {
    $(".text-danger").each(function() {
        ...
        2 == t ? $("#content .product-list").attr("class", "product-layout product-grid col-lg-6 col-md-6 col-sm-12 col-xs-12") : 1 == t ? $("#content .product-list").attr("class", "product-layout product-grid col-lg-4 col-md-4 col-sm-6 col-xs-12") : $("#content .product-list").attr("class", "product-layout product-grid col-lg-3 col-md-3 col-sm-6 col-xs-12"), localStorage.setItem("display", "grid")
            ...
            return this.each(function() {
                this.timer = null, this.items = new Array, t.extend(this, e), t(this).attr("autocomplete", "off"), t(this).on("focus", function() {
                    ...
                    if (html = "", e.length) {
                        ...
                        for (i = 0; i < e.length; i++) e[i].category || (e[i].image.length > 2 ? html += '<li data-value="' + e[i].value + '"><img src="' + e[i].image + '"/><a href="#">' + e[i].label + "</a></li>" : html += '<li data-value="' + e[i].value + '"><a href="#">' + e[i].label + "</a></li>");
                        var o = new Array;
                        for (i = 0; i < e.length; i++) e[i].category && (o[e[i].category] || (o[e[i].category] = new Array, o[e[i].category].name = e[i].category, o[e[i].category].item = new Array), o[e[i].category].item.push(e[i]));
                        for (i in o)
                            for (html += '<li class="dropdown-header">' + o[i].name + "</li>", j = 0; j < o[i].item.length; j++) o[i].item[j].image.length > 0 ? html += '<li data-value="' + o[i].item[j].value + '"><img src="' + o[i].item[j].image + '"/><a href="#">&nbsp;&nbsp;&nbsp;' + o[i].item[j].label + "</a></li>" : html += '<li data-value="' + o[i].item[j].value + '"><a href="#">&nbsp;&nbsp;&nbsp;' + o[i].item[j].label + "</a></li>"
                    }
